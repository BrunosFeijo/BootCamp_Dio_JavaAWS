...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Ordenação por título (comparable)");
        ...
        System.out.println("---------------------------------------");
        System.out.println("Ordenação por Ano (Comparator)");
        ...
        System.out.println("---------------------------------------");
        System.out.println("Ordenação por Autor (Compartor)");
        ...
        System.out.println("---------------------------------------");
        System.out.println("Ordenação por Ano, Autor e Título (Compartor)");
