...
public class Ex_3_Calculando_Custos {
    public static void main(String[] args) {
        ...
        double custoTotal = calcularTotal(quantidadeServidores,quantidadeBancosDados);
    ...
    public static double calcularTotal(int quantidadeServidores,int quantidadeBancosDados){
        // Definindo as taxas
        ...
        valorTotal += (quantidadeServidores * custoPorHoraServidor);
        valorTotal += (quantidadeBancosDados * custoPorHoraBancoDados);
